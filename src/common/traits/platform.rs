...
pub trait PlatformActions {
    ...
    fn print(printer: &Printer, buffer: &[u8], job_name: Option<&str>) -> Result<(), &'static str>;    
    fn print_file(printer: &Printer, file_path: &str, job_name: Option<&str>) -> Result<(), &'static str>;
